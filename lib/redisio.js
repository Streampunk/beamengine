...
async function queryRendition (target, depth = 1) {

}

async function reverseRendition (source, depth = 1) {

}

async function createTransformation (source, target, recipe = '', bounds = '') {

}

async function deleteTransformation (source, target) {

}

async function queryTransformation (source) {

}

async function reverseTransformation (source) {
